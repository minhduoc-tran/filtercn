...
The UI layer (`ui/`) contains 7 components. The simplest way is to copy them from the [GitHub repository](https://github.com/your-repo/filtercn/tree/main/src/components/conditional-filter/ui). Each component is self-contained and only imports from `../types`, `../constants`, and shadcn/ui.
