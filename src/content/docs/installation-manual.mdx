...
Copy the 7 files from the [GitHub repository](https://github.com/minhduoc-tran/filtercn/tree/main/src/components/conditional-filter/ui) into `src/components/conditional-filter/ui/`:
